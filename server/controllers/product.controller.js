...
async function deleteProduct(req, res) {
  try{
    ...
    res.status(httpStatus.CREATED).json({ message: "Successfully deleted product", deletedProduct});
  } catch(err) {
...
async function getProducts(req,res) {
  try{
    ...
    const products =  await productService.getproducts(pageNum, req.query.limit, filter)
